...
<main id="main">
  ...
  <div class="container">
    ...
    <div class="section-title">
      <span>Instansi Kesehatan Rumah Sakit Umum</span>
      <h2>Instansi Kesehatan Rumah Sakit Umum</h2>
    ...
    <div class="row"> 
    <?php $rsum = $conn->query("SELECT * FROM preferensi WHERE jenis='Rumah Sakit Umum' ORDER BY nilai_preferensi DESC"); 
                if($rsum->num_rows>0){
      ...
      <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
        <div class="member">
        <img src="bs/eNno/assets/img/team/<?= $pecah['gambar']?>" alt="">
          <h4><?= $pecah['jenis']; ?> </h4>
