        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a href="#" class="dropdown-item">Hi!<?php echo $_SESSION['nama_user']; ?></a></li>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-Success" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="sb-sidenav-menu-heading">SPK</div>
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="alternative.php">Alternative</a>
                                <a class="nav-link" href="kriteria.php">Kriteria</a>
                                <a class="nav-link" href="penilaian.php">Penilaian</a>
                                <a class="nav-link" href="hasil.php">Hasil Perhitungan</a>
                            </nav>
                        </div>
                    </div>
                </div>
